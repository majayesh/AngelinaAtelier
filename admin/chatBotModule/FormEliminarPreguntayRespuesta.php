...
class FormEliminarPreguntayRespuesta
{

    public function eliminarPreguntayRespuestaShow()
    {
...
?>
        ...
        <head>
            ...
            <title>Eliminar Pregunta y Respuesta</title>
        </head>
        ...
        <body class="container ">
                ...
                <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <div class="nav-item">
                                <span class="fs-4">Eliminar Pregunta y Respuesta</span>
                            </div>
                            <div class="nav-item">
            ...
            <form action="./get_eliminarpreguntayrespuesta.php" method="post">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach($_SESSION['preguntasyrespuestas'] as $preguntayrespuesta): ?>
                            <tr>
                                ...
                                <td><button name="btnEliminarPreguntayRespuesta" type="submit" onclick="return confirm('¿Seguro que desea eliminar la pregunta <?php echo $preguntayrespuesta->pregunta ?>?');" value="<?php echo $preguntayrespuesta->idchatbot ?>"><img src="../shared/assets/modelos/icons/eliminar.svg" height="25px" width="25px" alt=""></button></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
