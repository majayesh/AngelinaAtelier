...
class FormModificarNoticia
{

    public function formModificarNoticiaShow()
    {
...
?>
        ...
        <head>
            ...
            <script src="../shared/assets/js/ci_formmodificarnoticia.js" type="text/javascript"></script>
            <title>Formulario Modificar Noticia</title>
        </head>
        ...
        <body class="container">
            ...
            <h1 class="page-header">Modificar Noticia</h1>
                ...
                <div class="container">
                    ...
                    <form class="well form-horizontal" action="./get_modificarnoticia.php" method="post"  id="contact_form">
                    ...
                    <div class="form-group">
                        ...
                        <input name="titular" placeholder="Nuevos métodos de pago en Angelina Atelier" class="form-control" type="text" value="<?php echo $_SESSION["noticia"][0]->titular ?>" maxlength="70">
                          </div>
                        </div>
                    </div>
                  ...
                  <!-- Text input-->
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                      <input name="resena" placeholder="Yape,Plin llegan a Angelina Atelier como métodos de pago opcionales." class="form-control" type="text" value="<?php echo $_SESSION["noticia"][0]->resena ?>" maxlength="100">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <select name="estado" class="form-control">
                                ...
                                <?php foreach ($_SESSION['estados'] as $estado) : ?>
                                    <?php if($estado->idestado==$_SESSION['noticia'][0]->idestado): ?>
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label">Imagen(*)</label> 
                        ...
                        <div class="input-group">
                            ...
                            <img src="<?= $_SESSION['noticia'][0]->imagen ?>" alt="" id="image" width="305" height="305" id="btn-image">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <button name="btnModificarNoticia" type="submit" class="btn btn-warning" value="<?php echo $_SESSION["noticia"][0]->idnoticia ?>">Modificar noticia &nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-saved"></span></button>
                      </div>
                    </div>
