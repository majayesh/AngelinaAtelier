...
class FormVerNoticias
{

    public function noticiasShow()
    {
...
?>
        ...
        <head>
            ...
            <script src="../shared/assets/js/ci_formVerNoticias.js" type="text/javascript"></script>
                ...
                <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <div class="nav-item">
                                <span class="fs-4">Ver Noticias</span>
                            </div>
                            <div class="nav-item">
