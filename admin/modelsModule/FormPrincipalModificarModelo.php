...
class FormPrincipalModificarModelo
{

    public function modificarModeloShow()
    {
...
?>
        ...
        <body class="container ">
                ...
                <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <div class="nav-item">
                                <span class="fs-4">Modificar Modelo</span>
                            </div>
                            <div class="nav-item">
            ...
            <form action="./get_modificarmodelo.php" method="post">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach($_SESSION['modelos'] as $model): ?>
                            <tr>
                                ...
                                <td><button name="btnFormModificarModelo" type="submit" value="<?php echo $model->idmodelo ?>"><img src="../shared/assets/modelos/icons/modificar.svg" height="25px" width="25px" alt=""></button></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
