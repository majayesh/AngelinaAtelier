...
class FormEliminarUsuario
{
    ...
    public function eliminarUsuarioShow()
    {
...
?>
        ...
        <body class="container ">
                ...
                <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <div class="nav-item">
                                <span class="fs-4">Eliminar Usuario</span>
                            </div>
                            <div class="nav-item">
            ...
            <form action="./get_eliminarusuario.php" method="post">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach($_SESSION['usuarios'] as $users): ?>
                            <tr>
                                ...
                                <td><button name="btnEliminarUsuario" type="submit" onclick="return confirm('¿Seguro que desea eliminar el usuario <?php echo $users->nombre ?>?');" value="<?php echo $users->idusuario ?>"><img src="../shared/assets/modelos/icons/eliminar.svg" height="25px" width="25px" alt=""></button></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
